...
$writer = ConvertFrom-JsonCompat (& .\.github\skills\pr-review-writer\scripts\pr_review_writer.ps1 -InputPath .github\skills\pr-jira-review\assets\mock\default-review-bundle.json -OutputFormat json -DraftPath test-output\smoke-writer-review.md | Out-String)
...
$review = ConvertFrom-JsonCompat (& .\.github\skills\pr-jira-review\scripts\review_pr.ps1 -Mode mock -OutputFormat json -DraftPath test-output\smoke-main-review.md | Out-String)
...
$publish = ConvertFrom-JsonCompat (& .\.github\skills\pr-review-publisher\scripts\pr_review_publisher.ps1 -PrUrl https://github.com/acme/payments-service/pull/123 -DraftPath test-output\smoke-main-review.md -Mode mock | Out-String)
